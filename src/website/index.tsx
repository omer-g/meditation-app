import { Container, Stack, Title, Text, Anchor, List, Image, Group } from '@mantine/core';
...
export default function Website() {
  return (
    <Container size="sm" px="md" pt="xl">
      <Stack gap="md">
        <Group justify="center" align="center" gap={12} wrap="nowrap">
        ...
        <Text>
          The app is also available as a <Anchor href='../'>phone app</Anchor> for Android. This version is
